...
<div class="chat-message user">
    ...
    <div class="avatar">
        <img src="https://cdn.icon-icons.com/icons2/582/PNG/512/girl_icon-icons.com_55043.png" style="max-height: 78px; max-width: 78px; border-radius: 50%; object-fit: cover;">
    </div>    
</div>
'''
